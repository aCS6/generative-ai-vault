...
def generate_product_script(
    ...
    return "DONE", conversation_history


def update_product_data_or_parameters(product_data, script_parameters, updates):
    for key, value in updates.items():
        if key in product_data:
            product_data[key] = value
        elif key in script_parameters:
...
# Generate the initial product script
...
# Example of user updating the product data or parameters
user_updates = {
    "productName": "Ultra Hand Cream",
    "priceRRP": 17.99,
    "tone": "Formal",
    "length": "Short",
    "focus": "Ingredients",
...
# Apply the updates
update_product_data_or_parameters(product_data, script_parameters, user_updates)

# Regenerate the product script with updated data
script, conversation_history = generate_product_script(
    product_data,
    script_parameters,
    system_messages,
